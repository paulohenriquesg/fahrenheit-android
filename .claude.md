...
When committing DTO consolidation changes, use descriptive messages:

```
Consolidate Author DTOs to support search and detailed responses
Consolidate MediaProgress and change Float to Double for precision
Add helper extensions for dual-format metadata handling
```
